...
template<typename E>
EnumConverter<E>::~EnumConverter()
{}

template<typename E>
E EnumConverter<E>::getEnumerated() const
{
  return enumerated_;
}

template<typename E>
int EnumConverter<E>::getId() const
{
  return getId(enumerated_);
}

template<typename E>
std::string EnumConverter<E>::str() const
{
  return str(enumerated_);
}

template<typename E>
const char* EnumConverter<E>::c_str() const
{
  return str().c_str();
}

template<typename E>
void EnumConverter<E>::operator =(int id)
{
  enumerated_ = getEnumerated(id);
}

template<typename E>
void EnumConverter<E>::operator =(std::string nome)
{
  enumerated_ = getEnumerated(nome);
}

template<typename E>
void EnumConverter<E>::operator =(E enumerated)
{
  enumerated_ = enumerated;
}
